...
class MonthlyProfitAndLoss(DiscordMessage):
    def __init__(self, start_month_date: datetime = None,
                       end_month_date: datetime = None,
                       realised_pl: float = None,
                       account_value: float = None,
                       trading_platform: Broker = None):
        super().__init__()
        
        self.__start_month_date = start_month_date
        self.__end_month_date = end_month_date
        ...
        embed = discord.Embed(title=f'Monthly Realised Profit and Loss from {start_month_date.strftime("%Y-%m-%d")} to {end_month_date.strftime("%Y-%m-%d")}\n') 
    ...
    def __members(self):
        return (self.__start_month_date, self.__end_month_date,
                self.__realised_pl, self.__account_value,
                self.__trading_platform)

    def __eq__(self, other: object) -> bool:
        if isinstance(other, MonthlyProfitAndLoss):
    ...
    @property
    def start_month_date(self):
        return self.__start_month_date
    
    @start_month_date.setter
    def start_month_date(self, start_month_date):
        self.__start_month_date = start_month_date
        
    @property
    def end_month_date(self):
        return self.__end_month_date
    
    @end_month_date.setter
    def end_month_date(self, end_month_date):
        self.__end_month_date = end_month_date
