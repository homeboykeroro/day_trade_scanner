...
class YearToDateProfitAndLoss(DiscordMessage):
    def __init__(self, settle_date: datetime = None,
        ...
        embed = discord.Embed(title=f'Year to Date Realised Profit and Loss on {settle_date.strftime("%Y-%m-%d")}\n')
    ...
    def __eq__(self, other: object) -> bool:
        if isinstance(other, YearToDateProfitAndLoss):
