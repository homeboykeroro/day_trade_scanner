...
class WeeklyProfitAndLoss(DiscordMessage):
    def __init__(self, start_week_date: datetime = None,
                       end_week_date: datetime = None,
                       realised_pl: float = None,
                       account_value: float = None,
                       trading_platform: Broker = None):
        super().__init__()
        
        self.__start_week_date = start_week_date
        self.__end_week_date = end_week_date
        ...
        embed = discord.Embed(title=f'Weekly Realised Profit and Loss from {start_week_date.strftime("%Y-%m-%d")} to {end_week_date.strftime("%Y-%m-%d")}\n')
    ...
    def __members(self):
        return (self.__start_week_date,
                self.__end_week_date,
                self.__realised_pl,
                self.__account_value,
                self.__trading_platform)

    def __eq__(self, other: object) -> bool:
        if isinstance(other, WeeklyProfitAndLoss):
    ...
    @property
    def start_week_date(self):
        return self.__start_week_date
    
    @start_week_date.setter
    def start_week_date(self, start_week_date):
        self.__start_week_date = start_week_date
        
    @property
    def end_week_date(self):
        return self.__end_week_date
    
    @end_week_date.setter
    def end_week_date(self, end_week_date):
        self.__end_week_date = end_week_date
