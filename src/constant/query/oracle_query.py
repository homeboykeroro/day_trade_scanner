...
class OracleQuery(str, Enum):
    ...
    GET_API_ENDPOINT_LOCK_BY_LOCKED_BY_QUERY = "SELECT * FROM API_ENDPOINT_LOCK WHERE LOCKED_BY = :locked_by"
    ...
    # For Previous Day Top Gainer Scraper
    ...
    # For IPO List
    ADD_IPO_LIST_QUERY = "INSERT INTO IPO_LIST (TICKER, COMPANY_NAME, OFFERING_PRICE, OFFERING_SHARES, OFFERING_AMOUNT, IPO_DATETIME, OFFICAL_WEBSITE, ADDRESS, NUMBER_OF_EMPLOYEE) VALUES (:1, :2, :3, :4, :5, :6, :7, :8, :9)"
    DELETE_IPO_QUERY = "DELETE FROM IPO_LIST WHERE TICKER = :ticker"
    GET_IPO_QUERY = "SELECT * FROM IPO_LIST WHERE TICKER = :ticker"
    ...
    COUNT_PATTERN_ANALYSIS_MESSAGE_BY_DAILY_BASIS_QUERY = "SELECT * FROM PATTERN_ANALYSIS WHERE TICKER = :ticker AND TRUNC(HIT_SCANNER_DATETIME, 'DD') = TRUNC(:hit_scanner_datetime, 'DD') AND SCAN_PATTERN = :scan_pattern AND BAR_SIZE = :bar_size"
