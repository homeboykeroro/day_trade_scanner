...
class OracleQuery(str, Enum):
    ...
    GET_TOP_GAINER_QUERY = "SELECT * FROM TOP_GAINER_HISTORY WHERE PERCENTAGE >= :percentage AND TRUNC(SCAN_DATE, 'DD') BETWEEN TRUNC(:start_datetime, 'DD') AND TRUNC(:end_datetime, 'DD') ORDER BY SCAN_DATE, PERCENTAGE DESC"    
